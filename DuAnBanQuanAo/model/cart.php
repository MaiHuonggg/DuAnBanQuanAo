        ...
        echo '
            <tbody> 
                <tr>
                    ...
                    <td>'.$cart[6].'</td>
                    <td>'.$cart[5].'</td>
                    <td>'.number_format($cart[3] * $cart[4]).' VNĐ</td>
                    '.$xoasp_td.'
                </tr>
            </tbody>';
        $i+=1;
        ...
        echo '
            <tbody> 
                <tr>
                    ...
                    <td>'.$cart['size'].'</td>
                    <td>'.$cart['color'].'</td>
                    <td>'.number_format($cart['price'] * $cart['soluong']).' VNĐ</td>
                </tr>
            </tbody>';
        $i+=1;
    } 
...
function insert_cart($iduser,$idpro,$img,$name,$price,$soluong,$thanhtien,$size,$color,$idbill){
    $sql="insert into cart(iduser,idpro,img,name,price,soluong,thanhtien,idbill,size,color) values('$iduser','$idpro','$img','$name','$price','$soluong','$thanhtien','$idbill', '$size','$color')";
